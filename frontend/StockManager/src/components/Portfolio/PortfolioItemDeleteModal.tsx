...
const PortfolioItemDeleteModal = ({open, portfolioItem, onClose, onDelete} : Props) => {
    return (
        <div className={`modal ${open ? "is-active" : ""}`}>
            ...
            <div className="modal-card">
                ...
                <section className="modal-card-body">
                    Are you sure you want to delete {portfolioItem?.stock?.symbol}?
                ...
                <footer className="modal-card-foot is-justify-content-right">
                    ...
                    <button className="button is-danger" onClick={() => { onDelete(portfolioItem?.id); onClose() }}>
                        Delete
                    </button>
                </footer>
            </div>
